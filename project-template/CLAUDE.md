...
This file is the contract between you (Claude Code, the **worker**) and the human
(the **inspirator / validator**). It is loaded automatically every session. Read it
fully before doing anything. It is deliberately short — depth lives in the task files.
